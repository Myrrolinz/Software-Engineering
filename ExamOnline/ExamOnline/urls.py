...
from user.views import RegisterViewSet, StudentViewSet, UpdatePwdApi, ClazzListViewSet, submit_form
...
router.register(r'payment', submit_form)

urlpatterns = [
    path('xadmin/', xadmin.site.urls),
    path('docs/', include_docs_urls('CET在线练习系统')),
